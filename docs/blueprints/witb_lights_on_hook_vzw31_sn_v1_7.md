# WITB Lights ON Hook (VZW31-SN) v1.7

## Scope

- Source blueprint: `blueprints/script/witb_lights/v1/witb_lights_on_hook_profile_vzw31_sn_switch_bulb_v1_7.yaml`
- Blueprint name: `WITB Lights ON Hook (Profile: VZW31-SN Switch + Bulb)`
- Domain: `script`
