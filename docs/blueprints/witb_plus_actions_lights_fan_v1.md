...
- Occupancy logic from `blueprints/automation/witb_plus/v3/witb_plus.yaml`
- Helpers generated by:
  - `blueprints/automation/witb_plus_actions_lights_fan/v1/generate_witb_plus_actions_packages.py`
...
1. Create occupancy with WITB+ v3 and verify `binary_sensor.<slug>_occupied_effective`.
