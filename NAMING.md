...
- All filenames use `lowercase_snake_case` except `README.md` and `CHANGELOG_*.md` which use uppercase prefixes by convention.
- Words are separated by underscores (`_`). No hyphens in new files.
- Version directories use the form `v<N>` (e.g., `v1`, `v2`, `v4`).
...
blueprints/
  automation/
    <blueprint_name>/           # family folder — contains README.md
      README.md
